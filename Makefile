...
#    Updated: 2020/05/11 13:32:26 by tfarenga         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_putendl_fd.c ft_putnbr_fd.c ft_strdup.c
...
ft_strchr.o ft_strlcpy.o ft_strlcat.o ft_memset.o ft_bzero.o ft_memcpy.o \
ft_memccpy.o ft_memmove.o ft_memchr.o ft_memcmp.o ft_putchar_fd.o ft_putstr_fd.o \
ft_putendl_fd.o ft_putnbr_fd.o ft_strdup.o
#$(SRC:.c=.o)
